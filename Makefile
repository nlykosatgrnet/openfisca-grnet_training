...
install: deps
	...
	@# `make install` installs the editable version of openfisca-grnet_training.
...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_grnet_training openfisca_grnet_training/tests

serve-local: build
	openfisca serve --country-package openfisca_grnet_training
